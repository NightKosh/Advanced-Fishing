...
public class AFItems {
    ...
    public static final DeferredHolder<Item, Item> COOKED_CRUCIAN =
            ITEMS_REGISTER.register("cooked_crucian", () -> new Item(new Item.Properties()
                    .setId(ResourceKey.create(Registries.ITEM, fromNamespaceAndPath(ModInfo.ID, "cooked_crucian")))
                    .food(new FoodProperties.Builder()
                            .nutrition(8)
