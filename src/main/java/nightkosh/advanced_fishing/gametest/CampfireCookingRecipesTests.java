...
public class CampfireCookingRecipesTests {
    ...
    protected static void defaultTest(GameTestHelper helper, String recipeName, Item input, ItemStack expected) {
        ...
        var res = fromNamespaceAndPath(ModInfo.ID, "campfire/" + recipeName);
        ...
        if (!(recipeByKey.get() instanceof CampfireCookingRecipe)) {
            helper.fail("Recipe " + recipeName + " isn't an instance of CampfireCookingRecipe: " + recipeByKey.get());
            return;
        }
